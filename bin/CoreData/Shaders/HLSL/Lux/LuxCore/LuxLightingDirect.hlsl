...
inline HALF4 LightingLuxDirect_PrePass (SurfaceOutputLux s, HALF4 light)
{
...
/*
inline HALF4 LightingLuxDirect_DirLightmap (SurfaceOutputLux s, HALF4 color, HALF4 scale, HALF3 viewDir, bool surfFuncWritesNormal, out HALF3 specColor)
{
	UNITY_DIRBASIS
